        ...
        <nav className={`flex flex-row justify-center w-full p-2 ${isSticky ? 'sticky' : ''} top-0 h-[3.25rem] sm:h-[3.5rem] 
                ...
                <>
                    <div className="basis-1/3 justify-self-center">
                        <div className="w-[450px] mx-auto grid grid-cols-3 h-full space-x-2 hidden lg:grid">
                            <Link to="/projects">
                                <button className="w-full h-full bg-slate-800 hover:bg-[#5297FF] rounded-lg hover:font-medium decoration-slate-100 decoration-2 hover:scale-[102%] pointer-events-auto">
            ...
            {showLogin &&
                ...
                <div className={`${showNav ? 'basis-1/3' : 'basis-1/2'} justify-self-end flex flex-row-reverse`}>
                    <button className="h-full w-[110px] sm:w-[140px] bg-slate-800 hover:bg-[#5297FF] rounded-lg hover:font-medium decoration-slate-100 decoration-2 hover:scale-[102%] pointer-events-auto">
