    ...
    return (
        <Link to={linkPath} ref={ref1} className={`transition-opacity duration-500 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
            <button className={`group/fade-button relative ${width} ${height} rounded-lg bg-slate-800 hover:font-medium hover:scale-[102%] transition-all duration-150 overflow-hidden pointer-events-auto ${extraClass}`}>
                <div className={`absolute ${width} ${height} top-0 left-[-100%] opacity-20 scale-[101%] group-hover/fade-button:opacity-100 group-hover/fade-button:translate-x-[200%] duration-200 bg-gradient-to-r from-20% from-nebdev pointer-events-none`} />
                <div className={`absolute ${width} ${height} top-0 left-[-200%] opacity-20 scale-[101%] group-hover/fade-button:opacity-100 group-hover/fade-button:translate-x-[200%] duration-200 bg-nebdev pointer-events-none`} />
